# Empresas y Usuarios — Resumen del microservicio

## Propósito

administra los datos y la lógica del dominio de Empresas y Usuarios del caso caso01 (WorkMatch).

## Contexto

- **Caso**: caso01 — WorkMatch (Portal de busqueda de empleo (empresas))
