# Empresas y Usuarios — Despliegue y operación
...
| API base | `/api/empresas` |

## Docker

```bash
docker build -t duoc/jv0101-caso01-empresas:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso01-empresas:1.0.0
```
